...
class Day02(unittest.TestCase):
    ...
    def test_part1(self):
        self.assertEqual(sum(self.score1[ln] for ln in input_lines(day=2)), 13221)

    def test_part2(self):
        self.assertEqual(sum(self.score2[ln] for ln in input_lines(day=2)), 13131)
